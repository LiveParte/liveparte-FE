  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        {/* Signup Card - Clean Glassmorphism Style */}
        <motion.div
          variants={itemVariants}
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="px-4 py-3 bg-grey.100/50 border-grey.400/30 text-white.200 placeholder-grey.200 focus:border-yellow.100/50 focus:ring-yellow.100/20"
                />
              </div>
              {errors.email && (
                <motion.p
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className="px-4 py-3 pr-12 bg-grey.100/50 border-grey.400/30 text-white.200 placeholder-grey.200 focus:border-yellow.100/50 focus:ring-yellow.100/20"
                />
                <button
                  type="button"
            ...
            {formData.password && (
              <motion.div
                ...
                className="bg-grey.100/20 rounded-lg p-3 space-y-2"
              >
                ...
                {passwordRequirements.map((req, index) => (
                  ...
                  >
                    <Check
                      className={`w-4 h-4 ${
                        req.met ? "text-green.100" : "text-grey.200"
                      }`}
                    />
                    <span
                      className={`text-sm ${
            ...
            <div>
              <label className="flex items-start space-x-3 text-grey.200 text-sm">
                <input
                  type="checkbox"
                  name="agreeToTerms"
                  checked={formData.agreeToTerms}
                  onChange={handleInputChange}
                  className="w-4 h-4 text-yellow.100 bg-grey.100/50 border-grey.400/30 rounded focus:ring-yellow.100/20 mt-0.5"
                />
                <span>
                  I agree to the{" "}
                  <button
