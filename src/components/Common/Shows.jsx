...
export default function ShowsCard({
  ...
  // alert(id)
    const backUrl = id==1?`bg-[url('/webp/show.png')]`:`bg-[url('/webp/show2.png')]`
  ...
  return (
    ...
    >
      <div className="h-full">
        ...
        {showHeader &&  <span>
         {isLive? <div className="mt-[8px] lg:mt-[22px] ml-[8px] lg:ml-[16px] rounded-[9px] flex gap-[8px] items-center px-[5px] lg:px-[10px] py-[6px] bg-[#b3b2b4] w-fit ">
            <div className="h-[8px] w-[8px] rounded-full bg-[#FA4354]"></div>
            <div className="text-[11px] lg:text-[13px] xl:text-[15px] text-white">
              Happening now
            </div>
          </div>:
          <div className="bg-[#263644] w-fit text-white px-[9px] py-[6px] mt-[8px] lg:mt-[22px] ml-[8px] lg:ml-[16px] rounded-[9px] text-[11px] lg:text-[13px] xl:text-[15px]">March 24</div>
          }
          </span>}
