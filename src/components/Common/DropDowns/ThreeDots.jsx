...
export function DropdownMenu({
  ...
  return (
    <div className=" absolute dropdownIII transform translate-x-[-220px] lg:translate-x-[-200px] -translate-y-[60px] z-30">
      <div className=" bg-[#1B1C20] border-[1px] text-left border-[#343F4B] text-[13px] md:text-[14px] text-white  rounded-[16px] md:w-[327px] w-[80vw]     px-[40px] py-[24px]">
        ...
        <div className="my-[12px] cursor-pointer" onClick={openModalShareEvent}>
          Share Event
        </div>
          ...
          <div className="py-[12px]">
            <a
              ...
              href={`https://calendar.google.com/calendar/r/eventedit?text=${replaceAmpersandWithAnd(
                ...
                HeroSectionEvent?.event_date
              )}&details=<b>${replaceAmpersandWithAnd(
                HeroSectionEvent?.name
              )}</b><br/><br/><b>Location:</b>${replaceAmpersandWithAnd(
                HeroSectionEvent?.country
              )}
              <br/>
              <br/>
              <b>Description:</b>${replaceAmpersandWithAnd(
