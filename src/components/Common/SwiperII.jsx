...
export default function App() {
  ...
  const slideTo = (index) => {
    swiperRef.slideTo(index - 1, 1);
  };
  const slideToII = (index) => {
  ...
  return (
    <div className='bg-white'>
      ...
      <p className="append-buttons">
        ...
        <button onClick={() => slideToII(1)} className="prepend-slide">
          Slide 1
        </button>
        ...
        <button onClick={() => slideBack()} className="slide-back">
  Slide Back
</button>
      </p>
    </div>
