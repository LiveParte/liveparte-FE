...
import { Dropdown, DropdownButton } from "react-bootstrap";
 ...
 function HeaderMd({
  ...
  return (
    <div className="  z-50">
      <div className="absolute  left-0 right-0 px-[16px] lg:px-[18px] top-0 py-[17px] flex justify-between text-white   lg:rounded-[16px]">
      <div className="lg:pt-[32px] pb-[27px]  hidden sm:block">
       <LogoImage />
     </div>
    ...
    <div className="md:hidden">
      <div className="absolute  left-0 right-0 px-[16px] lg:px-[18px] top-0 py-[17px] flex justify-between text-white z-30 bg-gradient-to-b h-[5vh] md:h-[18vh] sm:h-[20vh] items-start from-[#060809]  lg:rounded-[16px]">
        {!isLoading && (
