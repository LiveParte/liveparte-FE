...
import { Dropdown, DropdownButton } from "react-bootstrap";
 ...
 function HeaderMd({
  ...
  return (
    <div className="  z-50">
      <div className="absolute  left-0 right-0 px-[16px] lg:px-[18px] top-0 py-[17px] flex justify-between text-white z-30 bg-gradient-to-b h-[30vh] items-start from-[#060809]  lg:rounded-[16px]">
