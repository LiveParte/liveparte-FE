...
import { useForgetPasswordMutation, useRegisterApiMutation, useRestPasswordMutation } from "@/store/User/userApi";
...
export default function ForgetPassword({
  ...
  const handleForgetPassword = async(data)=>{
    ...
    if(responses?.data?.message=="Password reset token has been sent to your email"){
  ...
  const ForgetPasswordPage = [
    ...
    {
      name:'EnterPassword',
      component:<EnterPassword isLoading={resetLoader} handleSubmit={handleSubmit} control={control} onNext={(data)=>handleResetPassword(data)}/>
    },
    {
      name:'IsSuccessPage',
