...
export default function EventButton({
  ...
  console.log(buttonAction(),'HeroSectionEvent1')
  ...
  function CallToActionIcon() {
    return (
      <div className="flex gap-4 items-center h-[44px]">
       ...
       {buttonAction()==="isPaidAndEventIsLive"&& <div className="relative  leading-none">
          {isOpen && (
            <DropdownMenu
        ...
        {buttonAction()!=="isPaidAndEventIsLive"&&   <div className=" cursor-pointer" onClick={toggleMute}>
  ...
  return (
    ...
    // </div>
    <div
      className="mb-[80px] flex h-[44px] items-center gap-4"
      ref={dropdownRef}
    >
