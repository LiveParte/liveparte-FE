      ...
      <div className="flex flex-col lg:flex-row gap-[16px] ">
        <div className="  flex-1 bg-[#27292E] lg:pt-[32px] lg:px-[24px] lg:rounded-[16px]">
          ...
          >
            ...
            <div className="absolute left-0 right-0 px-[18px] bottom-0 py-[17px] flex justify-end text-white z-50 bg-gradient-to-t h-[100px] items-end from-black rounded-[16px]">
              <div>
            ...
            <div className="w-full h-[40vh] lg:h-[70vh] bg-[url('/webp/livestream.webp')]  bg-cover rounded-[16px] overflow-hidden "></div>
            {/* <Media>
              <Video
              ...
              >
                <video
                  ...
                  src="https://res.cloudinary.com/dammymoses/video/upload/v1693130876/TestVideos/React_Navbar_Change_Background_Color_on_Scroll_-_React_JS_Website_Tutorial_adbriq.mp4"
                  preload="none"
                  data-video="0"
                  controls
                />
        ...
        <div className="  lg:rounded-[26px] bg-[#222428]">
          <Chat />
        </div>
      </div>
    </main>
