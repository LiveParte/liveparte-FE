import VideoJsControl from '@/components/modules/LiveStream/submodules/videosubmodules/modules/players/videoJsControl';
 ...
 const  {
  ...
  useEffect(() => {
    playerRef.current = videojs(videoRef.current, {
      ...
      autoplay: true,
      preload: "auto",
      muted: true, // Muted to bypass autoplay restrictions
    });

    playerRef.current.on('loadeddata', () => {
      setDuration(playerRef.current.duration());
      attemptPlay(); // Try to play after data is loaded
    });
