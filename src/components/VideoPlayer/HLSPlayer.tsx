...
const HLSPlayer = forwardRef<any, any>(({
  ...
  }, [src, autoPlay, isLive, debug, onPlay, onPause, onTimeUpdate, onLoadedMetadata, onError, onHlsStats, hlsLoaded]);
    ...
    return (
      <div className={`flex items-center justify-center bg-red-900/20 border border-red-500/30 rounded-lg p-8 ${className}`}>
        <div className="text-center">
          <div className="text-red-400 text-lg font-semibold mb-2">HLS Error</div>
